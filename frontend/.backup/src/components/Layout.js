...
const Layout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'AI Guidance', href: '/ai-guidance', icon: BrainCircuitIcon },
    { name: 'Career Atlas', href: '/career-atlas', icon: MapIcon },
    { name: 'Portfolio', href: '/portfolio', icon: FolderIcon },
    { name: 'Interview Prep', href: '/interview-prep', icon: MicIcon },
    { name: 'Gamification', href: '/gamification', icon: GamepadIcon },
