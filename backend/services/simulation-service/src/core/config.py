"""
🔒 SECURE CONFIGURATION - SIMULATION SERVICE
...
class Settings(BaseSettings):
    """
    Secure configuration for Simulation Service
    ...
    service_port: int = Field(default=5004, env="SIMULATION_PORT")
    ...
    # 🎯 SIMULATION SPECIFIC
    career_path_simulation_enabled: bool = Field(default=True, env="CAREER_PATH_SIMULATION_ENABLED")
    market_trends_analysis: bool = Field(default=True, env="MARKET_TRENDS_ANALYSIS")
    salary_predictions_enabled: bool = Field(default=True, env="SALARY_PREDICTIONS_ENABLED")
    
    # Simulation Parameters
    simulation_years_ahead: int = Field(default=10, env="SIMULATION_YEARS_AHEAD")
    market_data_cache_ttl: int = Field(default=86400, env="MARKET_DATA_CACHE_TTL")  # 24 hours
    max_simulation_scenarios: int = Field(default=5, env="MAX_SIMULATION_SCENARIOS")
...
try:
    ...
    print("✅ Simulation Service: All environment variables validated successfully")
except ValueError as e:
    print(f"❌ Simulation Service: {e}")
